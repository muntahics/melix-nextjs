...
export default function TvDetails({id, title, seasons, episodes ,backdrop,poster,genres, imdb, imdbRating, overview, production_companies, production_countries, release_date, languages, runtime, cast, directors}:MovieDetailsProps):JSX.Element{
