...
export default function SeasonCard({tmdb_id, poster, title, date, season_number, episode_count}:{tmdb_id:number, poster:string, title:string, date:string, season_number:number, episode_count: number}):JSX.Element{
