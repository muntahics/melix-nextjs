        ...
        <main className="lg:flex lg:flex-col lg:justify-center lg:items-center">
            <div className="flex flex-col md:flex-row m-6 lg:max-w-360">
                ...
                <div className="flex flex-col justify-start max-sm:gap-2 gap-4 md:ml-6">
                    ...
                    <Link href={`/movie/${id}/view`}><button className="self-start bg-cyan-200 p-2 shadow-md rounded-xl text-gray-800 cursor-pointer active:bg-amber-100 hover:bg-amber-300 transition duration-300 ease-in-out">Watch Now</button></Link>
                    <span className="block text-gray-300">Genre: {genreNames}</span> 
                    <span className="block text-gray-300">Runtime: {Math.floor(runtime/60)+`h `+runtime%60+`m`}</span> 
                    ...
                    <span className="block text-gray-300">Directors: {directors}</span> 
