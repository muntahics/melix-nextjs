...
const humanReadableRelease = `${day} ${month}, ${year}`;
    ...
    return(
        <div className="rounded-2xl border-4 border-gray-500 px-2 py-2 text-amber-100 shadow-2xl hover:transition-transform transition-discrete duration-300 ease-in-out delay-150 hover:scale-105">
